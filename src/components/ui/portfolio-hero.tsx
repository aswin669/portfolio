    ...
    >
      ...
      <main className="relative min-h-screen flex flex-col">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full px-4 pointer-events-none">
          <div className="relative text-center">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-auto">
              <div className="w-[90px] h-[150px] sm:w-[120px] sm:h-[200px] md:w-[150px] md:h-[250px] lg:w-[180px] lg:h-[300px] rounded-full overflow-hidden shadow-2xl transition-transform duration-300 hover:scale-110 cursor-pointer">
                <img
                  src="https://images.unsplash.com/photo-1544723795-3fb6469f5b39?auto=format&fit=crop&w=720&q=80"
                  alt="Profile"
        ...
        <div className="absolute bottom-16 sm:bottom-20 md:bottom-24 lg:bottom-32 xl:bottom-36 left-1/2 -translate-x-1/2 w-full px-6 z-20">
          ...
          {/* Resume Download Button */}
          <div className="flex justify-center mt-8 relative z-50 pointer-events-auto">
            <a
              href="/resume.pdf"
